...
| ADR | 제목 | Status |
|-----|------|--------|
| [0001](./0001-contract-a-retrieve-only.md) | Contract A — retrieve 전용 RAG 연동. 원문만 retrieve는 0008이, 도구 검색은 0010이, 평가기 루프는 0011이 대체 | Accepted |
...
| [0008](./0008-retrieve-query-rewrite.md) | retrieve 전 대화 기반 쿼리 리라이트 | Superseded by 0010 |
| [0009](./0009-langgraph-pipeline.md) | 채팅 파이프라인은 LangGraph가 소유. 단일 LLM 노드 래퍼는 대체 | Accepted |
| [0010](./0010-retrieve-as-answer-tool.md) | 시드 retrieve 후 답변 LLM이 도구로 재검색 | Superseded by 0011 |
| [0011](./0011-retrieve-sufficiency-evaluator.md) | 별도 평가기가 retrieve 충분성을 판단. 최대 3회, top_k 5/10/20 | Accepted |
